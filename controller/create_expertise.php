...
$strSQL = "SELECT * FROM expertise_person WHERE p_pid = '$per_id' AND (p_pid != '' AND p_pid IS NOT NULL) AND p_delete = 'N'";
...
$strSQL = "INSERT INTO expertise_person
           ...
           VALUES
           ('$per_id', '$fname_en', '$lname_en', '$fname_th', '$lname_th', '$position_en', '$position_th', '$sysdatetime', '$sysdatetime')
          ";
